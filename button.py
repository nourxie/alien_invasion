...
class Button():
	...
	def __init__(self, ri_game, msg):
		...
		self.font = pygame.font.Font('planetk.TTF', 30)
...
class Game_Over():
	def __init__(self, ai_settings, screen, msg):
		...
		self.button_color = (161, 242, 226)
		self.text_color = (15, 112, 93)
		self.font = pygame.font.Font('font/planetk.TTF', 60)
